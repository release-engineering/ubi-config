...
htmlhelp_basename = "ubi-configdoc"
...
latex_documents = [
    (master_doc, "ubi-config.tex", "ubi-config Documentation", "Red Hat", "manual")
]
...
man_pages = [(master_doc, "ubi-config", "ubi-config Documentation", [author], 1)]
