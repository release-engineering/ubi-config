...
def test_modules():
	data = {'include': [{'name': 'nodejs', 'stream': 8, 'profiles': ['interpreter']},
...
def test_content_sets():
	data = {'rpm': {'input': 'rhel-7-for-power-le-rpms',
					'output': 'ubi-7-for-power-le-rpms'},
			'srpm': {'input': 'rhel-7-for-power-le-source-rpms',
					 'output': 'ubi-7-for-power-le-source-rpms'},
			'debuginfo':{'input': 'rhel-7-for-power-le-debug-rpms',
	...
	expected_exported_dict = {'rpm': ('rhel-7-for-power-le-rpms',
									  'ubi-7-for-power-le-rpms'),
							  'srpm': ('rhel-7-for-power-le-source-rpms',
							  		   'ubi-7-for-power-le-source-rpms'),
							  'debuginfo': ('rhel-7-for-power-le-debug-rpms',
